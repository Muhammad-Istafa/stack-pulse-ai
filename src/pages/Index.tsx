...
export default function Index() {
  useEffect(() => {
    document.title = "Stack Pulse — Private Intelligence";
  }, []);
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="philosophy" className="px-6 py-28 text-center border-t border-border">
        ...
        <div className="mt-20 grid md:grid-cols-3 border border-border max-w-5xl mx-auto">
          {[
            ...
            { num: "III · Discretion", title: "The counsel that does not leave the room", body: "No attribution. No records. Stack Pulse operates on invitation, confidential by architecture, and exists only between advisor and principal." },
          ].map((p, i) => (
      ...
      >
        ...
        <p className="mt-12 font-display font-thin text-[9px] tracking-[0.4em] uppercase text-primary/50">
          Stack Pulse · Internal Doctrine · MMXXV
        </p>
      </section>
      ...
      <section id="membership" className="px-6 py-28 text-center">
        ...
        <p className="font-serif-display italic text-[17px] font-light text-foreground/60 max-w-lg mx-auto leading-[1.8] mb-16">
          Stack Pulse does not advertise. We extend access to founders referred by existing members, or those who have come to our attention through work of consequence.
        </p>
